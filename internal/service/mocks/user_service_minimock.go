...
//go:generate minimock -i github.com/igorezka/auth/internal/service.UserService -o user_service_minimock.go -n UserServiceMock -p mocks
	...
	if mmCreate.CreateMock.defaultExpectation != nil {
		...
		if mm_want_ptrs != nil {
			...
			if mm_want_ptrs.userCreate != nil && !minimock.Equal(*mm_want_ptrs.userCreate, mm_got.userCreate) {
				mmCreate.t.Errorf("UserServiceMock.Create got unexpected parameter userCreate, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
	...
	if mmUpdate.UpdateMock.defaultExpectation != nil {
		...
		if mm_want_ptrs != nil {
			...
			if mm_want_ptrs.userUpdate != nil && !minimock.Equal(*mm_want_ptrs.userUpdate, mm_got.userUpdate) {
				mmUpdate.t.Errorf("UserServiceMock.Update got unexpected parameter userUpdate, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
