...
//go:generate minimock -i github.com/igorezka/auth/internal/repository.UserRepository -o user_repository_minimock.go -n UserRepositoryMock -p mocks
...
func (mmCreate *mUserRepositoryMockCreate) ExpectUserCreateParam2(userCreate *model.UserCreate) *mUserRepositoryMockCreate {
	...
	mmCreate.defaultExpectation.expectationOrigins.originUserCreate = minimock.CallerInfo(1)
	...
	if mmCreate.CreateMock.defaultExpectation != nil {
		...
		if mm_want_ptrs != nil {
			...
			if mm_want_ptrs.userCreate != nil && !minimock.Equal(*mm_want_ptrs.userCreate, mm_got.userCreate) {
				mmCreate.t.Errorf("UserRepositoryMock.Create got unexpected parameter userCreate, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
					mmCreate.CreateMock.defaultExpectation.expectationOrigins.originUserCreate, *mm_want_ptrs.userCreate, mm_got.userCreate, minimock.Diff(*mm_want_ptrs.userCreate, mm_got.userCreate))
			}
...
func (mmUpdate *mUserRepositoryMockUpdate) ExpectUserUpdateParam3(userUpdate *model.UserUpdate) *mUserRepositoryMockUpdate {
	...
	mmUpdate.defaultExpectation.expectationOrigins.originUserUpdate = minimock.CallerInfo(1)
	...
	if mmUpdate.UpdateMock.defaultExpectation != nil {
		...
		if mm_want_ptrs != nil {
			...
			if mm_want_ptrs.userUpdate != nil && !minimock.Equal(*mm_want_ptrs.userUpdate, mm_got.userUpdate) {
				mmUpdate.t.Errorf("UserRepositoryMock.Update got unexpected parameter userUpdate, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
					mmUpdate.UpdateMock.defaultExpectation.expectationOrigins.originUserUpdate, *mm_want_ptrs.userUpdate, mm_got.userUpdate, minimock.Diff(*mm_want_ptrs.userUpdate, mm_got.userUpdate))
			}
